...
export class InteractableView extends Component<Props> {
  static defaultProps = {
    dragToss: 0.1,
    dragEnabled: true,
  ...
  constructor(props) {
    ...
    if (props.boundaries) {
      snapBuckets[0].push(
        bounceBehavior(dt, target, obj, props.boundaries, props.boundaries.bounce),
      )
    }
  ...
  snapTo({ index }) {
    ...
    this.props.onSnap && this.props.onSnap({ nativeEvent: { ...snapPoint, index } })
  }
