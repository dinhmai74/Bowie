...
export type LoginMutation = { __typename?: 'Mutation' } & {
  login: { __typename?: 'UserResponse' } & {
    ...
    error?: Maybe<{ __typename?: 'FieldError' } & Pick<FieldError, 'message'>>
  }
}
...
export type AuthMutation = { __typename?: 'Mutation' } & {
  auth?: Maybe<{ __typename?: 'User' } & Pick<User, 'email' | 'name'>>
}
...
export type GetAllEventsQuery = { __typename?: 'Query' } & {
  getEvents: { __typename?: 'EventsResponse' } & {
    events?: Maybe<
      Array<
        { __typename?: 'Event' } & Pick<Event, 'id' | 'hostId' | 'endTime' | 'startTime'> & {
            membersInfo: Array<{ __typename?: 'MemberInfo' } & Pick<MemberInfo, 'id' | 'type'>>
            information: { __typename?: 'Information' } & Pick<
              Information,
...
export type GetEventByCoordQuery = { __typename?: 'Query' } & {
  getEventBaseOnPos: { __typename?: 'EventsWithHostResponse' } & {
    events?: Maybe<
      Array<
        { __typename?: 'EventWithHost' } & Pick<EventWithHost, 'id' | 'endTime' | 'startTime'> & {
            hostInfo?: Maybe<
              { __typename?: 'UserWithAvt' } & Pick<UserWithAvt, 'id' | 'name' | 'email'> & {
                  avatar?: Maybe<{ __typename?: 'Image' } & Pick<Image, 'data' | 'contentType'>>
                }
            >
...
export type GetEventByIdQuery = { __typename?: 'Query' } & {
  getEventById: { __typename?: 'EventResponse' } & {
    event?: Maybe<
      { __typename?: 'Event' } & Pick<Event, 'id' | 'hostId' | 'endTime' | 'startTime'> & {
          membersInfo: Array<{ __typename?: 'MemberInfo' } & Pick<MemberInfo, 'id' | 'type'>>
          information: { __typename?: 'Information' } & Pick<
    ...
    >
    error?: Maybe<{ __typename?: 'FieldError' } & Pick<FieldError, 'path' | 'message'>>
  }
}
...
export type GetAllUsersQuery = { __typename?: 'Query' } & {
  getAllUsers: { __typename?: 'UsersResponse' } & {
    users?: Maybe<Array<{ __typename?: 'User' } & Pick<User, 'id' | 'email'>>>
    error?: Maybe<{ __typename?: 'FieldError' } & Pick<FieldError, 'message' | 'path'>>
  }
}
...
export type GetCurrentUserInfoQuery = { __typename?: 'Query' } & {
  me?: Maybe<
    { __typename?: 'UserWithAvtResponse' } & {
      user?: Maybe<
        { __typename?: 'UserWithAvt' } & Pick<UserWithAvt, 'email' | 'id' | 'name' | 'avatarId'> & {
            avatar?: Maybe<{ __typename?: 'Image' } & Pick<Image, 'data' | 'contentType'>>
          }
      >
      error?: Maybe<{ __typename?: 'FieldError' } & Pick<FieldError, 'path' | 'message'>>
