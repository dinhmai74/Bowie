...
export type DisbandEventMutation = { __typename?: 'Mutation' } & Pick<Mutation, 'disbandEvent'>
...
`
export type DisbandEventMutationFn = ApolloReactCommon.MutationFunction<
  DisbandEventMutation,
  DisbandEventMutationVariables
>
 ...
 * });
 */
export function useDisbandEventMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    DisbandEventMutation,
    DisbandEventMutationVariables
  >,
) {
  return ApolloReactHooks.useMutation<DisbandEventMutation, DisbandEventMutationVariables>(
    DisbandEventDocument,
    baseOptions,
  )
}
...
export type DisbandEventMutationOptions = ApolloReactCommon.BaseMutationOptions<
  DisbandEventMutation,
  DisbandEventMutationVariables
>
