...
const BookResponse_1 = require("../graphql-types/BookResponse");
...
let BookResolver = class BookResolver {
    ...
    getBooks() {
        return __awaiter(this, void 0, void 0, function* () {
            const books = yield mikroconfig_1.DI.bookRepository.findAll();
            return {
                books,
            };
        });
...
__decorate([
    type_graphql_1.Query(() => BookResponse_1.BooksResponse),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
